...
public class DnacoMessageHttpDecoder extends MessageToMessageDecoder<FullHttpRequest> {
  public static final DnacoMessageHttpDecoder INSTANCE = new DnacoMessageHttpDecoder();

  private DnacoMessageHttpDecoder() {
    // no-op
  }
  ...
  public static DnacoMessage decode(final FullHttpRequest request) {
    ...
    return new DnacoMessage(0, metadata, data);
  }
}
