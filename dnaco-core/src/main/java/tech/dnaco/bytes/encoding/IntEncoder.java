...
public abstract class IntEncoder {
  ...
  // ================================================================================
  public int writeUnsignedVarLong(final byte[] buf, final int off, long v) {
    int length = 0;
  ...
  public int writeUnsignedVarLong(final OutputStream stream, long v) throws IOException {
    int length = 0;
    while ((v & 0xFFFFFFFFFFFFFF80L) != 0L) {
