...
public final class SemanticVersion {
  ...
  public static long compose(final int major, final int minor, final int patch) {
    if (patch < 0 || patch >= (1 << 23)) throw new IllegalArgumentException("patch must be 0-8388607: " + patch);
    if (minor < 0 || minor >= (1 << 20)) throw new IllegalArgumentException("patch must be 0-1048575: " + minor);
    if (major < 0 || major >= (1 << 20)) throw new IllegalArgumentException("major must be 0-1048575: " + major);
