...
public class IntHashSet {
  ...
  public IntHashSet(final int missingValue, final int initialCapacity) {
    this(missingValue, initialCapacity, DEFAULT_LOAD_FACTOR);
  }

  public IntHashSet(final int missingValue, final int initialCapacity, final float loadFactor) {
  ...
  public static IntHashSet fromArray(final int missingValue, final int[] values) {
    final IntHashSet hashSet = new IntHashSet(missingValue, Math.round(values.length * 1.5f));
