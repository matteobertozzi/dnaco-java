...
public final class XXHash {
  public static final long DEFAULT_SEED_64 = Math.round(Math.random() * 0xdef3f6abd9L);
  public static final int DEFAULT_SEED_32 = Math.toIntExact(Math.round(Math.random() * 0x19df3));
