...
public class TestStringFormat {
  ...
  public void testBasic() {
    ...
    assertEquals("foo 10 bar [20, 30] car 30 zar", StringFormat.format("foo {} bar {key} car {1} zar", 10, new int[] { 20, 30 }, 30));
  }

  @Test
  public void testSupplier() {
    assertEquals("foo Lazy 1 bar 10 car", StringFormat.format("foo {} bar {key} car", () -> "Lazy 1", () -> 10));
  }
