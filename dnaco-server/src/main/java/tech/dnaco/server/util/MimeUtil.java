...
package tech.dnaco.server.util;
...
public final class MimeUtil {
  ...
  /*
   * The list is limited to the most common mime types known to be compressable.
   * Compressing already compressed content does not harm other than wasting some CPU cycles.
   */
