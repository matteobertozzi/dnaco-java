...
public class IntDeltaOfDeltaDecoder {
  private final IntReader intReader;

  private long lastValue;
  private long lastDelta;

  public IntDeltaOfDeltaDecoder(final IntReader intReader) {
    this.intReader = intReader;
  }

  public long readNext() {
    final long deltaD = intReader.readLong();
    final long delta = deltaD + lastDelta;
