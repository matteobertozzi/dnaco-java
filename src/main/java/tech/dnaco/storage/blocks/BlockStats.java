...
public class BlockStats {
  ...
  public String toString() {
    return "BlockStats [keyMinLength=" + keyMinLength + ", keyMaxLength=" + keyMaxLength
        + ", valueMinLength=" + valueMinLength + ", valueMaxLength=" + HumansUtil.humanSize(valueMaxLength)
        + ", seqIdMin=" + seqIdMin + ", seqIdMax=" + seqIdMax
        + ", timestampMin=" + timestampMin + ", timestampMax=" + timestampMax
        + ", keySize=" + HumansUtil.humanSize(keySize)
        + ", valueSize=" + HumansUtil.humanSize(valueSize)
        + ", rowCount=" + rowCount + "]";
  }
}
